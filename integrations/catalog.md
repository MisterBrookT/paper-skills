...
| [`Imbad0202/academic-research-skills`](https://github.com/Imbad0202/academic-research-skills) | CC BY-NC 4.0 | reference / adapter only | Full research-to-publication pipeline; non-commercial license is not compatible with direct MIT redistribution. |
...
| [`jaechang-hits/SciAgent-Skills`](https://github.com/jaechang-hits/SciAgent-Skills) | CC BY 4.0 | adapter / attributed adaptation | Deep bioinformatics and life-science skill library; copying requires explicit attribution and modification notes. |
